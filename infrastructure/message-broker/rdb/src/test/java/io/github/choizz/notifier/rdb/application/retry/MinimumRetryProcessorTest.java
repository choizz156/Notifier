...
class MinimumRetryProcessorTest {
	...
	@InjectMocks
	private MinimumRetryProcessor processor;

	@DisplayName("지원하는 NotificationType인 경우 true를 반환한다.")
	@Test
	void test1() {
		boolean support = processor.support(NotificationType.COURSE_START_REMINDER); // MINIMUM
	...
	@Test
	void test2() {
		assertThat(processor.getRdbRetryLevel()).isEqualTo(RetryLevel.MINIMUM);
	}
}
